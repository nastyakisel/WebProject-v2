...
public class AddGoodtoCartCommand implements Command {
	private static final Logger logger = LogManager.getLogger(AddGoodtoCartCommand.class.getName());
	...
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		Integer drugId = Integer.parseInt(request.getParameter("drugId"));
 		...
 		if (userId == null) {
 			...
 			Drug drug = null;
 			try {
 				drug = goodService.getGoodById(drugId);
